import 'package:cubit_todoapp/pages/todo_pages/todos_page.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<ActiveTodoCountCubit>(create: (context) => 
        ...
        BlocProvider<FilteredTodosCubit>(create: (context) => 
        FilteredTodosCubit(
